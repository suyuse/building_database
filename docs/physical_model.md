...
| oktmo       | INTEGER | NOT NULL, UNIQUE                             |
| district_id | INTEGER | FK (federal_districts.district_id), NOT NULL |

## federal_districts
| Колонка     | Тип     | Ограничения                        |
|-------------|---------|------------------------------------|
| district_id | INTEGER | PK, NOT NULL                       |
| name        | TEXT    | NOT NULL, UNIQUE                   |
...
| quarter           | INTEGER | PK, NOT NULL, CHECK (quarter IN (1, 2, 3, 4)) |
